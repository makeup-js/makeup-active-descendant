...
$_mod.installed("makeup-active-descendant$0.3.1", "nodelist-foreach-polyfill", "1.2.0");
...
$_mod.installed("makeup-active-descendant$0.3.1", "custom-event-polyfill", "1.0.7");
...
$_mod.installed("makeup-active-descendant$0.3.1", "makeup-navigation-emitter", "0.3.0");
...
$_mod.installed("makeup-active-descendant$0.3.1", "makeup-next-id", "0.1.1");
$_mod.def("/makeup-active-descendant$0.3.1/index", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/makeup-active-descendant$0.3.1/docs/index", function(require, exports, module, __filename, __dirname) { "use strict";

/* eslint-disable no-console */
var ActiveDescendant = require('/makeup-active-descendant$0.3.1/index'/*'../index.js'*/);
...
$_mod.run("/makeup-active-descendant$0.3.1/docs/index");